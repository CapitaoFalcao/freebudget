      ...
      <div class="container">
          <div class="row text-center">
              <div class="error-page">
                <h2><a rel="nofollow" href="https://rebrand.ly/gg-engage-purchase/">8=========b<br> Purchase Full Version to Get All Pages and Features</a></h2>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-4 col-sm-6 col-xs-12">
            <div class="images">
              <img src="img/about/plain-why-choose-us-2.png" alt="">
            </div>
          </div>
